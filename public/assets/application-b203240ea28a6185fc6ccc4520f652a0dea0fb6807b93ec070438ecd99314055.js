...
(function() { this.JST || (this.JST = {}); this.JST["annotations/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- <form class="annotation-form" style="top:',  annotation.get("top") ,'px;"> -->\n<h1>New Annotation</h1>\n\n<div class="form-group">\n  <textarea name="body"\n            class="form-control"\n            rows="5"\n            placeholder="Body">',  annotation.escape("body") ,'</textarea>\n</div>\n\n<br>\n<button>Submit</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["annotations/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  annotation.escape("body") ,'\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>New Recipe</h1>\n\n<div class="form-group">\n  <input type="text"\n         name="title"\n         class="form-control"\n         placeholder="Title"\n         value="',  recipe.escape("title") ,'">\n</div>\n<br>\n\n<div class"form-group">\n  <textarea name="body"\n            class="form-control"\n            rows="5"\n            placeholder="Body">',  recipe.escape("body") ,'</textarea>\n</div>\n<br>\n\n<div class"form-group">\n  <input type="text"\n         name="image_url"\n         class="form-control"\n         value="',  recipe.escape("image_url") ,'"\n         placeholder="Image URL">\n</div>\n\n<div class="input-group">\n  <span class="input-group-addon" id="sizing-addon2">\n    <span class="glyphicon glyphicon-tags" aria-hidden="true"></span>\n  </span>\n  <input type="text"\n         data-role="tokenfield"\n         name="tags"\n         class="form-control tag-field"\n         placeholder="Tags">\n</div>\n\n<br>\n<button>Submit</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="recipes">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>',  recipe.escape("title") ,'</h1>\nposted by ',  recipe.escape("author") ,'\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>',  recipe.escape("title") ,'</h1>\n<h2>Posted by ',  recipe.escape("author") ,' </h2>\n');  recipe.tags().each(function(tag) { ; __p.push('\n  <a href="#/tags/',  tag.escape("id") ,'">',  tag.escape("label") ,'</a>\n  ');  }) ; __p.push('\n<a href="">Recipe Index</a>\n<br>\n<pre class="recipe-body col-md-6">\n  ',  recipe.escape("body") ,'\n</pre>\n\n<div class="annotation-container col-md-6">\n</div>\n\n<br>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["tags/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>',  tag.escape("label") ,'</h1>\n\n<h2>Recipes</h2>\n<div class="recipes">\n</div>\n');}return __p.join('');};
}).call(this);
